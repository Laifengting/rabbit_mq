...
public class MqConstant {
    ...
    public static final String LAZY_EXCHANGE2 = "lazy.exchange2";
    ...
    public static final String LAZY_QUEUE2 = "lazy.queue2";
    ...
    public static final String LAZY_ROUTING_KEY = "lazy.routingkey";
    public static final String LAZY_ROUTING_KEY2 = "lazy.routingkey2";
    // 死信 RoutingKey
