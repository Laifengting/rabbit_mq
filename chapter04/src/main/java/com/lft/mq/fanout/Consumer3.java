...
public class Consumer3 {
    private static Logger log = LoggerFactory.getLogger(Consumer3.class);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // 绑定交换机和临时队列
            channel.queueBind(queueName, "test.fanout", "");
            // 设置每次从通道中获取一个消息
            channel.basicQos(1);
            // 接收消息
            channel.basicConsume(queueName, false, new DefaultConsumer(channel) {
                ...
                public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties,
                                           ...
                                           byte[] body)
                        throws IOException {
                    System.out.println("Consumer3 消费到的消息为：" + new String(body));
