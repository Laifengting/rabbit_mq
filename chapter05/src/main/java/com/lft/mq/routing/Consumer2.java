...
public class Consumer2 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // 绑定交换机和临时队列
            channel.queueBind(queueName, MQConstants.EXCHANGE_NAME, MQConstants.ROUTING_KEY_1);
            channel.queueBind(queueName, MQConstants.EXCHANGE_NAME, MQConstants.ROUTING_KEY_2);
            channel.queueBind(queueName, MQConstants.EXCHANGE_NAME, MQConstants.ROUTING_KEY_3);
            // 设置每次从通道中获取一个消息
            channel.basicQos(1);
            // 接收消息
